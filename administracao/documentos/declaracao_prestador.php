...
$sqladdservidor = "SELECT c.titulo, f.* FROM db_rh.tb_funcionario as f INNER JOIN db_rh.tb_cargo as c ON (f.fk_cargo = c.id) WHERE f.id = '$buscanome' and status='ATIVO' ORDER BY f.nome ASC";
