...
<div id="busca_impressao">
    ...
    <div id="imprime_resultado">
        <style>
            ...
            #tabela_funcionarios_filter label input, #tabela_funcionarios_filter label{
        ...
        <table class="table table-striped table-bordered table-hover  table-sm tablesorter" id="tabela_funcionarios">
            ...
            <tbody>
                ...
                if (mysqli_num_rows($resultbusca) > 0) {
                    ...
                    servidores[$dados->idfuncionario]['cargo'] = '$ref_mes';
...
<script type="text/javascript" src="/siiupa/administracao/pagina_rh_home.js?v=<?=$idunico;?>"></script>
<?php
