...
<body>
    ...
    <div class="flexbox">
        <?php
        $nomeBd = new BD;
        $sqlNome = "SELECT id, nome, data_nasc, sexo FROM db_rh.tb_funcionario WHERE status='ATIVO' and fk_cargo NOT IN ('20') and month(data_nasc) = '01' order by month(data_nasc), day(data_nasc) ASC;";
