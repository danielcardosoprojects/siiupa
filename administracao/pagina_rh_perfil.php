...
<div id='perfil'>
    ...
    echo "<table class='table table-sm'>
        <tbody>
            <tr>
                <td>";
    echo "<div class='rounded-circle float-right' style='width:120px; border:1px solid #000;height:120px;background-color:#fff;background-image:url(\"$foto_perfil\");background-size: 110px auto;background-repeat: no-repeat;background-position:center;' title='Foto perfil' alt='Sem foto' class='img-thumbnail  float-left'></div>";
