        ...
        */
        ...
        <table class="table caption-top  table-bordered table-hover" id="tabelaescala">
            ...
            <tbody>
                ...
                $sqlserv = "SELECT c.carga_horaria, c.funcao_upa, c.titulo, f.fk_cargo, f.nome, ef.* FROM db_rh.tb_escala_funcionario as ef INNER JOIN db_rh.tb_funcionario AS f ON (ef.fk_funcionario = f.id) INNER JOIN db_rh.tb_cargo AS c ON (f.fk_cargo = c.id) WHERE ef.fk_escala=$idescala order by ef.posicao ASC, f.nome ASC, ef.id ASC";
                $buscaserv = new BD;
