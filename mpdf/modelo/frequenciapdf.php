...
<div style='font-size:12px;font-family: "Times New Roman", Times, serif;'>
    Referência: <strong><?php echo GetNomeMes($mes); ?>-2022</strong><br />
...
function Mostra($mes, $dia)
{
    ...
    $diasemana = jddayofweek(cal_to_jd(CAL_GREGORIAN, $mes, $dia, 2022), 0);    // função que descobre o dia da semana
...
function DiaSemana($mes, $dia)
{
    ...
    $diasemana = jddayofweek(cal_to_jd(CAL_GREGORIAN, $mes, $diaa, 2022), 0);    // função que descobre o dia da semana
